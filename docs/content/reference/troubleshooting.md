...
Most of these come down to network reality or how hackernoon serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hackernoon rate-limits like any public site. hn2 already paces
...
Where a surface is gated, hn2 reads a cookie or token you supply
...
`hn2`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hn2 actually did
